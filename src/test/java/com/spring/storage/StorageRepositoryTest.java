...
public class StorageRepositoryTest extends WebAppConfigurationAware {
    ...
    public void deleteAllNewStorages() {
        ...
        log.debug(String.format("Storages before deletion: %s", Arrays.toString(returnedStorages.toArray())));
        storageRepository.deleteAll();
        returnedStorages = storageRepository.findAll();
        log.debug(String.format("Storages after deletion: %s", Arrays.toString(returnedStorages.toArray())));
    ...
    public void deleteAllNewAccounts() {
        ...
        log.debug(String.format("Accounts before deletion: %s", Arrays.toString(returnedAccounts.toArray())));
